...
[Diff](https://github.com/instrumentisto/medea-jason/compare/medea-jason-0.14.1...medea-jason-0.14.2)

See also [`medea_jason` pub package 0.14.2 changes](https://github.com/instrumentisto/medea-jason/tree/medea-jason-0.14.2/flutter/CHANGELOG.md).
...
- Dependencies:
    - [`flutter_rust_bridge`] crate to 2.12.0 version. ([#275])
...
## [0.14.1] · 2026-03-25
[0.14.1]: https://github.com/instrumentisto/medea-jason/tree/medea-jason-0.14.1

[Diff](https://github.com/instrumentisto/medea-jason/compare/medea-jason-0.14.0...medea-jason-0.14.1)

See also [`medea_jason` pub package 0.14.1 changes](https://github.com/instrumentisto/medea-jason/tree/medea-jason-0.14.1/flutter/CHANGELOG.md).
...
- `MediaDeviceDetails.sampleRate()` and `MediaDeviceDetails.numChannels()` methods (only accessible via Dart API). ([#264])
...
See also [`medea_jason` pub package 0.13.1 changes](https://github.com/instrumentisto/medea-jason/tree/medea-jason-0.13.1/flutter/CHANGELOG.md).
