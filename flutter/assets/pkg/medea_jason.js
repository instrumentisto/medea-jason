...
export class RemoteMediaTrack {
    ...
    */
    on_track_update(cb) {
        wasm.remotemediatrack_on_track_update(this.ptr, addHeapObject(cb));
    }
    /**
...
function getImports() {
    ...
    imports.wbg.__wbg_track_4dab9f254252a097 = function(arg0) {
    ...
    imports.wbg.__wbg_receiver_9236e323c512bfe7 = function(arg0) {
        const ret = getObject(arg0).receiver;
        return addHeapObject(ret);
    };
