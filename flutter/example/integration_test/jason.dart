...
void main() {
  try {
      ...
      try {
        ...
        expect(
            ...
            throwsA(predicate((e) =>
                ...
                e.kind() ==
                    LocalMediaInitExceptionKind.GetUserMediaAudioFailed &&
    ...
    testWidgets('DeviceVideoTrackConstraints', (WidgetTester tester) async {
      ...
      expect(() => constraints2.deviceId('deviceId'),
    ...
    testWidgets('RoomHandle', (WidgetTester tester) async {
      try {
        ...
        print('rh 10');
        expect(
            () => room.onNewConnection((_) {}), throwsA(isA<FfiException>()));
      } catch (e) {
        print('AAAA ${e}');
      }
    });
    ...
    testWidgets('ReconnectHandle', (WidgetTester tester) async {
      ...
      var exception5;
      try {
        await (returnsFutureWithRpcClientException('Dart err cause2')
            as Future);
      } catch (e) {
        exception5 = e;
      }
