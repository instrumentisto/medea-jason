...
required Pointer<NativeFunction<Void Function(Handle, ForeignValue)>> complete,
required Pointer<NativeFunction<Void Function(Handle, Pointer<Handle>)>> completeError,
