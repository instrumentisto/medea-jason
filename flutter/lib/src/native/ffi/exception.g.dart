...
required Pointer<NativeFunction<Handle Function(Pointer<Utf8>)>> newSetMicrophoneVolumeException,
required Pointer<NativeFunction<Handle Function(Pointer<Utf8>)>> newMicrophoneVolumeIsAvailableException,
required Pointer<NativeFunction<Handle Function(Pointer<Utf8>)>> newMicrophoneVolumeException,
required Pointer<NativeFunction<Handle Function()>> throwPanicException,
} ) {
dl.lookupFunction<Void Function(Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer), void Function(Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer)>('register_exception')(
newArgumentError,
newStateError,
newFormatException,
