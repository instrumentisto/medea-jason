...
class _$ApiConstrainFacingMode_ExactImpl extends ApiConstrainFacingMode_Exact {
  const _$ApiConstrainFacingMode_ExactImpl(this.field0) : super._();
...
abstract class ApiConstrainFacingMode_Exact extends ApiConstrainFacingMode {
  const factory ApiConstrainFacingMode_Exact(final FacingMode field0) =
      _$ApiConstrainFacingMode_ExactImpl;
  const ApiConstrainFacingMode_Exact._() : super._();
...
class _$ApiConstrainFacingMode_IdealImpl extends ApiConstrainFacingMode_Ideal {
  const _$ApiConstrainFacingMode_IdealImpl(this.field0) : super._();
...
abstract class ApiConstrainFacingMode_Ideal extends ApiConstrainFacingMode {
  const factory ApiConstrainFacingMode_Ideal(final FacingMode field0) =
      _$ApiConstrainFacingMode_IdealImpl;
  const ApiConstrainFacingMode_Ideal._() : super._();
