...
final _futureResolveOk = dl
    .lookupFunction<_FutureResolveOkC, _FutureResolveOkDart>(
...
final _futureResolveErr = dl
    .lookupFunction<_FutureResolveErrC, _FutureResolveErrDart>(
