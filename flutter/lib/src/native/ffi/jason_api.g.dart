...
class MedeaJasonWire implements FlutterRustBridgeWireBase {
  ...
  Object get_sender_codec_capabilities(
    int kind,
  ) {
    return _get_sender_codec_capabilities(
      kind,
    );
  }

  late final _get_sender_codec_capabilitiesPtr =
      _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Int64)>>(
          'get_sender_codec_capabilities');
  late final _get_sender_codec_capabilities =
      _get_sender_codec_capabilitiesPtr.asFunction<Object Function(int)>();
  ...
  late final _encodingsPtr =
      _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Handle)>>('encodings');
  late final _encodings = _encodingsPtr.asFunction<Object Function(Object)>();

  Object set_encoding(
    Object parameters,
    Object encoding,
  ) {
    return _set_encoding(
      parameters,
      encoding,
    );
  }

  late final _set_encodingPtr =
      _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Handle, ffi.Handle)>>(
          'set_encoding');
  late final _set_encoding =
      _set_encodingPtr.asFunction<Object Function(Object, Object)>();
  ...
  late final _add_transceiverPtr = _lookup<
      ffi.NativeFunction<
          ffi.Handle Function(
              ffi.Handle, ffi.Int64, ffi.Handle)>>('add_transceiver');
  late final _add_transceiver =
      _add_transceiverPtr.asFunction<Object Function(Object, int, Object)>();
  ...
  Object new_send_encoding_parameters(
    ffi.Pointer<ffi.Char> rid,
    bool active,
  ) {
    return _new_send_encoding_parameters(
      rid,
      active,
    );
  }

  late final _new_send_encoding_parametersPtr = _lookup<
      ffi.NativeFunction<
          ffi.Handle Function(ffi.Pointer<ffi.Char>,
              ffi.Bool)>>('new_send_encoding_parameters');
  late final _new_send_encoding_parameters = _new_send_encoding_parametersPtr
      .asFunction<Object Function(ffi.Pointer<ffi.Char>, bool)>();

  ffi.Pointer<ffi.Char> get_rid(
    Object encoding,
  ) {
    return _get_rid(
      encoding,
  ...
  late final _get_ridPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Handle)>>(
          'get_rid');
  late final _get_rid =
      _get_ridPtr.asFunction<ffi.Pointer<ffi.Char> Function(Object)>();
  ...
  late final _set_activePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Handle, ffi.Bool)>>(
          'set_active');
  late final _set_active =
      _set_activePtr.asFunction<void Function(Object, bool)>();

  void set_max_bitrate(
    Object encoding,
    int max_bitrate,
  ) {
    return _set_max_bitrate(
      encoding,
      max_bitrate,
    );
  }

  late final _set_max_bitratePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Handle, ffi.Int64)>>(
          'set_max_bitrate');
  late final _set_max_bitrate =
      _set_max_bitratePtr.asFunction<void Function(Object, int)>();

  void set_scale_resolution_down_by(
    Object encoding,
    int scale_resolution_down_by,
  ) {
    return _set_scale_resolution_down_by(
      encoding,
      scale_resolution_down_by,
    );
  }

  late final _set_scale_resolution_down_byPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Handle, ffi.Int64)>>(
          'set_scale_resolution_down_by');
  late final _set_scale_resolution_down_by =
      _set_scale_resolution_down_byPtr.asFunction<void Function(Object, int)>();

  void set_scalability_mode(
    Object encoding,
    ffi.Pointer<ffi.Char> scalability_mode,
  ) {
    return _set_scalability_mode(
      encoding,
      scalability_mode,
    );
  }

  late final _set_scalability_modePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Handle, ffi.Pointer<ffi.Char>)>>('set_scalability_mode');
  late final _set_scalability_mode = _set_scalability_modePtr
  ...
  Object create_transceiver_init(
    int direction,
  ) {
    return _create_transceiver_init(
      direction,
    );
  }

  late final _create_transceiver_initPtr =
      _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Int64)>>(
          'create_transceiver_init');
  late final _create_transceiver_init =
      _create_transceiver_initPtr.asFunction<Object Function(int)>();

  void add_sending_encodings(
    Object transceiver_init,
    Object encoding,
  ) {
    return _add_sending_encodings(
      transceiver_init,
      encoding,
    );
  }

  late final _add_sending_encodingsPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Handle, ffi.Handle)>>(
          'add_sending_encodings');
  late final _add_sending_encodings =
      _add_sending_encodingsPtr.asFunction<void Function(Object, Object)>();

  Object get_send_parameters(
    Object transceiver,
  ) {
    return _get_send_parameters(
      transceiver,
    );
  }

  late final _get_send_parametersPtr =
      _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Handle)>>(
          'get_send_parameters');
  late final _get_send_parameters =
      _get_send_parametersPtr.asFunction<Object Function(Object)>();

  Object set_send_parameters(
    Object transceiver,
    Object parameters,
  ) {
    return _set_send_parameters(
      transceiver,
      parameters,
    );
  }

  late final _set_send_parametersPtr =
      _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Handle, ffi.Handle)>>(
          'set_send_parameters');
