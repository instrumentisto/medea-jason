...
abstract class MedeaJason {
  ...
  FlutterRustBridgeTaskConstMeta get kLocalMediaTrackFacingModeConstMeta;
...
class MedeaJasonImpl implements MedeaJason {
  ...
  FacingMode? localMediaTrackFacingMode(
    ...
    var arg0 = _platform.api2wire_LocalMediaTrack(track);
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner.wire_local_media_track_facing_mode(arg0),
      parseSuccessData: _wire2api_opt_box_autoadd_facing_mode,
      constMeta: kLocalMediaTrackFacingModeConstMeta,
      argValues: [track],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kLocalMediaTrackFacingModeConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "local_media_track_facing_mode",
        argNames: ["track"],
      );
...
// Section: wire2api
  ...
  FacingMode _wire2api_box_autoadd_facing_mode(dynamic raw) {
    return _wire2api_facing_mode(raw);
  }

  FacingMode _wire2api_facing_mode(dynamic raw) {
    return FacingMode.values[raw];
  }
  ...
  FacingMode? _wire2api_opt_box_autoadd_facing_mode(dynamic raw) {
    return raw == null ? null : _wire2api_box_autoadd_facing_mode(raw);
  }
...
class MedeaJasonWire implements FlutterRustBridgeWireBase {
  ...
  WireSyncReturn wire_local_media_track_facing_mode(
    wire_LocalMediaTrack track,
  ) {
    return _wire_local_media_track_facing_mode(
      track,
    );
  }

  late final _wire_local_media_track_facing_modePtr = _lookup<
          ffi.NativeFunction<WireSyncReturn Function(wire_LocalMediaTrack)>>(
      'wire_local_media_track_facing_mode');
  late final _wire_local_media_track_facing_mode =
      _wire_local_media_track_facing_modePtr
          .asFunction<WireSyncReturn Function(wire_LocalMediaTrack)>();
