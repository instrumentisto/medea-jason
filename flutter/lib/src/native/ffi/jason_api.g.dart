...
// Section: wire2api
  ...
  ApiWrapVecLocalMediaTrack _wire2api_SyncReturn_ApiWrapVecLocalMediaTrack(
      dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return ApiWrapVecLocalMediaTrack.fromRaw(data.item1, data.item2, this);
  }

  ApiWrapVecMediaDeviceInfo _wire2api_SyncReturn_ApiWrapVecMediaDeviceInfo(
      dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return ApiWrapVecMediaDeviceInfo.fromRaw(data.item1, data.item2, this);
  }

  ApiWrapVecMediaDisplayInfo _wire2api_SyncReturn_ApiWrapVecMediaDisplayInfo(
      dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return ApiWrapVecMediaDisplayInfo.fromRaw(data.item1, data.item2, this);
  }

  AudioTrackConstraints _wire2api_SyncReturn_AudioTrackConstraints(
      dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return AudioTrackConstraints.fromRaw(data.item1, data.item2, this);
  }

  ConnectionHandle _wire2api_SyncReturn_ConnectionHandle(dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return ConnectionHandle.fromRaw(data.item1, data.item2, this);
  }

  Jason _wire2api_SyncReturn_Jason(dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return Jason.fromRaw(data.item1, data.item2, this);
  }

  LocalMediaTrack _wire2api_SyncReturn_LocalMediaTrack(dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return LocalMediaTrack.fromRaw(data.item1, data.item2, this);
  }

  MediaManagerHandle _wire2api_SyncReturn_MediaManagerHandle(dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return MediaManagerHandle.fromRaw(data.item1, data.item2, this);
  }

  MediaStreamSettings _wire2api_SyncReturn_MediaStreamSettings(dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return MediaStreamSettings.fromRaw(data.item1, data.item2, this);
  }
  ...
  MediaDeviceInfo? _wire2api_SyncReturn_Option_MediaDeviceInfo(dynamic raw) {
    ...
    var data = parseOpaquePtrAndSizeFrom(raw);
    return MediaDeviceInfo.fromRaw(data.item1, data.item2, this);
  }
  ...
  MediaDisplayInfo? _wire2api_SyncReturn_Option_MediaDisplayInfo(dynamic raw) {
    ...
    var data = parseOpaquePtrAndSizeFrom(raw);
    return MediaDisplayInfo.fromRaw(data.item1, data.item2, this);
  }
  ...
  ReconnectHandle _wire2api_SyncReturn_ReconnectHandle(dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return ReconnectHandle.fromRaw(data.item1, data.item2, this);
  }

  RemoteMediaTrack _wire2api_SyncReturn_RemoteMediaTrack(dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return RemoteMediaTrack.fromRaw(data.item1, data.item2, this);
  }

  RoomCloseReason _wire2api_SyncReturn_RoomCloseReason(dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return RoomCloseReason.fromRaw(data.item1, data.item2, this);
  }

  RoomHandle _wire2api_SyncReturn_RoomHandle(dynamic raw) {
    var data = parseOpaquePtrAndSizeFrom(raw);
    return RoomHandle.fromRaw(data.item1, data.item2, this);
  }
...
class MedeaJasonWire implements FlutterRustBridgeWireBase {
  ...
  WireSyncReturnStruct wire_audio_track_constr_new() {
  ...
  late final _wire_audio_track_constr_new = _wire_audio_track_constr_newPtr
      .asFunction<WireSyncReturnStruct Function()>();

  WireSyncReturnStruct wire_audio_track_constr_device_id(
  ...
  WireSyncReturnStruct wire_device_video_track_constr_new() {
  ...
  WireSyncReturnStruct wire_device_video_track_constr_device_id(
  ...
  WireSyncReturnStruct wire_device_video_track_constr_exact_facing_mode(
    wire_ApiWrapDeviceVideoTrackConstraints constr,
    int facing_mode,
  ) {
  ...
  late final _wire_device_video_track_constr_exact_facing_modePtr = _lookup<
      ffi.NativeFunction<
          WireSyncReturnStruct Function(wire_ApiWrapDeviceVideoTrackConstraints,
              ffi.Int64)>>('wire_device_video_track_constr_exact_facing_mode');
  ...
  WireSyncReturnStruct wire_device_video_track_constr_ideal_facing_mode(
    wire_ApiWrapDeviceVideoTrackConstraints constr,
    int facing_mode,
  ) {
  ...
  late final _wire_device_video_track_constr_ideal_facing_modePtr = _lookup<
      ffi.NativeFunction<
          WireSyncReturnStruct Function(wire_ApiWrapDeviceVideoTrackConstraints,
              ffi.Int64)>>('wire_device_video_track_constr_ideal_facing_mode');
  ...
  WireSyncReturnStruct wire_device_video_track_constr_exact_height(
    wire_ApiWrapDeviceVideoTrackConstraints constr,
    int exact_height,
  ) {
  ...
  WireSyncReturnStruct wire_device_video_track_constr_ideal_height(
    wire_ApiWrapDeviceVideoTrackConstraints constr,
    int ideal_height,
  ) {
  ...
  WireSyncReturnStruct wire_device_video_track_constr_exact_width(
    wire_ApiWrapDeviceVideoTrackConstraints constr,
    int exact_width,
  ) {
  ...
  WireSyncReturnStruct wire_device_video_track_constr_ideal_width(
    wire_ApiWrapDeviceVideoTrackConstraints constr,
    int ideal_width,
  ) {
  ...
  WireSyncReturnStruct wire_device_video_track_constr_height_in_range(
    wire_ApiWrapDeviceVideoTrackConstraints constr,
    int min,
    int max,
  ) {
  ...
  WireSyncReturnStruct wire_device_video_track_constr_width_in_range(
    wire_ApiWrapDeviceVideoTrackConstraints constr,
    int min,
    int max,
  ) {
  ...
  WireSyncReturnStruct wire_display_video_track_constr_new() {
  ...
  WireSyncReturnStruct wire_display_video_track_constr_device_id(
  ...
  WireSyncReturnStruct wire_display_video_track_constr_exact_height(
    wire_ApiWrapDisplayVideoTrackConstraints constr,
    int exact_height,
  ) {
  ...
  WireSyncReturnStruct wire_display_video_track_constr_ideal_height(
    wire_ApiWrapDisplayVideoTrackConstraints constr,
    int ideal_height,
  ) {
  ...
  WireSyncReturnStruct wire_display_video_track_constr_exact_width(
    wire_ApiWrapDisplayVideoTrackConstraints constr,
    int exact_width,
  ) {
  ...
  WireSyncReturnStruct wire_display_video_track_constr_ideal_width(
    wire_ApiWrapDisplayVideoTrackConstraints constr,
    int ideal_width,
  ) {
  ...
  WireSyncReturnStruct wire_display_video_track_constr_ideal_frame_rate(
    wire_ApiWrapDisplayVideoTrackConstraints constr,
  ...
  WireSyncReturnStruct wire_display_video_track_constr_exact_frame_rate(
    wire_ApiWrapDisplayVideoTrackConstraints constr,
  ...
  WireSyncReturnStruct wire_on_panic(
    wire_DartOpaque cb,
  ) {
  ...
  late final _wire_on_panicPtr = _lookup<
          ffi.NativeFunction<WireSyncReturnStruct Function(wire_DartOpaque)>>(
      'wire_on_panic');
  late final _wire_on_panic = _wire_on_panicPtr
      .asFunction<WireSyncReturnStruct Function(wire_DartOpaque)>();
