...
void registerFunctions(DynamicLibrary dl) {
  ...
  dl.lookupFunction<Void Function(Pointer), void Function(Pointer)>(
      'register_IceServers__add')(
      Pointer.fromFunction<Void Function(Handle, Pointer<Utf8>, ForeignValue, ForeignValue)>(addIceServer));
}
...
void addIceServer(Object servers, Pointer<Utf8> url, ForeignValue username, ForeignValue credentials) {
  servers as List;
