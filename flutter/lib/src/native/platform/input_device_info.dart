...
Pointer deviceId(Object deviceInfo) {
  if (deviceInfo is int) {
    print("ASDF: ${deviceInfo}");
  }
  print('At least its object with type: ${deviceInfo.runtimeType}');
  deviceInfo as MediaDeviceInfo;
