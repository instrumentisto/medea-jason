...
void registerFunction(
  ...
  _peer_connection__ice_connection_state__set_error = dl
  ...
  _peer_connection__restart_ice__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__restart_ice__set_error',
      );
  _peer_connection__rollback__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__rollback__set_error',
      );
  _peer_connection__get_stats__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__get_stats__set_error',
      );
  _peer_connection__on_track__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__on_track__set_error',
      );
  _peer_connection__on_ice_candidate__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__on_ice_candidate__set_error',
      );
  _peer_connection__on_ice_candidate_error__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__on_ice_candidate_error__set_error',
      );
  _peer_connection__get_transceiver_by_mid__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__get_transceiver_by_mid__set_error',
      );
  _peer_connection__add_ice_candidate__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__add_ice_candidate__set_error',
      );
  _peer_connection__on_ice_connection_state_change__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__on_ice_connection_state_change__set_error',
      );
  _peer_connection__new_peer__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__new_peer__set_error',
      );
  _peer_connection__add_transceiver__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__add_transceiver__set_error',
      );
  _peer_connection__create_offer__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__create_offer__set_error',
      );
  _peer_connection__create_answer__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__create_answer__set_error',
      );
  _peer_connection__set_local_description__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__set_local_description__set_error',
      );
  _peer_connection__set_remote_description__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
        'peer_connection__set_remote_description__set_error',
      );
  _peer_connection__close__set_error = dl
      .lookupFunction<_ErrorSetterFnC, _ErrorSetterFnDart>(
  ...
  Pointer<NativeFunction<Void Function(Handle, Handle)>>
  onIceCandidateError_native = Pointer.fromFunction(_onIceCandidateErrorProxy);
  Pointer<NativeFunction<Handle Function(Handle, Pointer<Utf8>)>>
  getTransceiverByMid_native = Pointer.fromFunction(_getTransceiverByMidProxy);
  ...
  setLocalDescription_native = Pointer.fromFunction(_setLocalDescriptionProxy);
  Pointer<NativeFunction<Handle Function(Handle, Pointer<Utf8>, Pointer<Utf8>)>>
