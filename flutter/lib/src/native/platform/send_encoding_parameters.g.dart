...
_ErrorSetterFnDart? _send_encoding_parameters__get_scale_resolution_down_by__set_error;
...
_send_encoding_parameters__get_active__set_error = dl.lookupFunction<_ErrorSetterFnC,_ErrorSetterFnDart>('send_encoding_parameters__get_active__set_error');
...
_send_encoding_parameters__get_max_bitrate__set_error = dl.lookupFunction<_ErrorSetterFnC,_ErrorSetterFnDart>('send_encoding_parameters__get_max_bitrate__set_error');
...
_send_encoding_parameters__get_scale_resolution_down_by__set_error = dl.lookupFunction<_ErrorSetterFnC,_ErrorSetterFnDart>('send_encoding_parameters__get_scale_resolution_down_by__set_error');
...
_send_encoding_parameters__get_scalability_mode__set_error = dl.lookupFunction<_ErrorSetterFnC,_ErrorSetterFnDart>('send_encoding_parameters__get_scalability_mode__set_error');
...
Pointer<NativeFunction<Bool Function(Handle)>> getActive_native = Pointer.fromFunction(_getActiveProxy,false);
Pointer<NativeFunction<Void Function(Handle, Uint32)>> setMaxBitrate_native = Pointer.fromFunction(_setMaxBitrateProxy,);
Pointer<NativeFunction<Pointer Function(Handle)>> getMaxBitrate_native = Pointer.fromFunction(_getMaxBitrateProxy,);
Pointer<NativeFunction<Void Function(Handle, Double)>> setScaleResolutionDownBy_native = Pointer.fromFunction(_setScaleResolutionDownByProxy,);
Pointer<NativeFunction<Double Function(Handle)>> getScaleResolutionDownBy_native = Pointer.fromFunction(_getScaleResolutionDownByProxy,0.0);
...
Pointer<NativeFunction<Pointer<Utf8> Function(Handle)>> getScalabilityMode_native = Pointer.fromFunction(_getScalabilityModeProxy,);

dl.lookupFunction<Void Function(Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer), void Function(Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer)>('register_send_encoding_parameters')(
...
bool _getActiveProxy(Object arg0) {try {
                        return _getActive!(arg0); } catch (e) { _send_encoding_parameters__get_active__set_error!(e); return false;
                     } }
...
Pointer _getMaxBitrateProxy(Object arg0) {try {
                        return _getMaxBitrate!(arg0); } catch (e) { _send_encoding_parameters__get_max_bitrate__set_error!(e); return Pointer.fromAddress(0);
                     } }
void _setScaleResolutionDownByProxy(Object arg0, double arg1) {try {
...
double _getScaleResolutionDownByProxy(Object arg0) {try {
                        return _getScaleResolutionDownBy!(arg0); } catch (e) { _send_encoding_parameters__get_scale_resolution_down_by__set_error!(e); return 0.0;
                     } }
...
Pointer<Utf8> _getScalabilityModeProxy(Object arg0) {try {
                        return _getScalabilityMode!(arg0); } catch (e) { _send_encoding_parameters__get_scalability_mode__set_error!(e); return Pointer.fromAddress(0);
                     } }
