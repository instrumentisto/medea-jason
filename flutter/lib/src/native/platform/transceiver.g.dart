...
required Pointer<NativeFunction<Handle Function(Handle, Handle)>> replaceTrack,
...
required Pointer<NativeFunction<Handle Function(Int64)>> createTransceiverInit,
required Pointer<NativeFunction<Void Function(Handle, Handle)>> addSendingEncodings,
required Pointer<NativeFunction<Handle Function(Handle)>> getSendParameters,
required Pointer<NativeFunction<Handle Function(Handle, Handle)>> setSendParameters,
} ) {
