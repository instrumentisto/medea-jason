...
///
/// Default: `127.0.0.1`
const String ipTestBase = String.fromEnvironment(
  'IP_TEST_BASE',
...
const String webdriverAddr = String.fromEnvironment(
  'WEBDRIVER_ADDR',
...
const String controlApiAddr = String.fromEnvironment(
  'CONTROL_API_ADDR',
...
const String clientApiAddr = String.fromEnvironment(
  'CLIENT_API_ADDR',
...
const String fileServerHost = String.fromEnvironment(
  'FILE_SERVER_HOST',
  defaultValue: '$ipTestBase:30000',
);

/// Path to a Cucumber features which should be run.
const String featuresPath = String.fromEnvironment(
  'FEATURES_PATH',
  defaultValue: 'tests/features',
);
