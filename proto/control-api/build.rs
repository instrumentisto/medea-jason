...
mod grpc {
    ...
    pub(crate) fn compile() -> Result<(), Box<dyn Error>> {
        ...
        // Remove the empty `google.protobuf.rs` file generated by
        // `prost-build`. This file doesn't affect to any functionality at the
        // moment.
        fs::remove_file(format!("{GRPC_DIR}/google.protobuf.rs"))?;
