...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 420685540;
...
fn wire__crate__api__dart__api__DART_HANDLER_PORT_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "DART_HANDLER_PORT", port: None, mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            deserializer.end();
                transform_result_sse::<_, ()>((move || {
                     let output_ok = Result::<_,()>::Ok(crate::api::dart::api::DART_HANDLER_PORT)?;   Ok(output_ok)
                })()) })
}
...
impl SseDecode for ::LocalKey<Cell<Option<i64>>> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(
        deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer,
    ) -> Self {
...
10 => wire__crate__api__dart__api__DART_HANDLER_PORT_impl(ptr, rust_vec_len, data_len),
11 => wire__crate__api__dart__api__jason__Jason_jason_close_room_impl(ptr, rust_vec_len, data_len),
12 => wire__crate__api__dart__api__jason__Jason_jason_dispose_impl(ptr, rust_vec_len, data_len),
13 => wire__crate__api__dart__api__jason__Jason_jason_init_room_impl(ptr, rust_vec_len, data_len),
14 => wire__crate__api__dart__api__jason__Jason_jason_media_manager_impl(ptr, rust_vec_len, data_len),
15 => wire__crate__api__dart__api__jason__Jason_new_impl(ptr, rust_vec_len, data_len),
16 => wire__crate__api__dart__api__local_media_track__LocalMediaTrack_free_impl(ptr, rust_vec_len, data_len),
17 => wire__crate__api__dart__api__local_media_track__LocalMediaTrack_from_ptr_impl(ptr, rust_vec_len, data_len),
18 => wire__crate__api__dart__api__local_media_track__LocalMediaTrack_get_track_impl(ptr, rust_vec_len, data_len),
19 => wire__crate__api__dart__api__local_media_track__LocalMediaTrack_is_on_audio_level_available_impl(ptr, rust_vec_len, data_len),
20 => wire__crate__api__dart__api__local_media_track__LocalMediaTrack_kind_impl(ptr, rust_vec_len, data_len),
21 => wire__crate__api__dart__api__local_media_track__LocalMediaTrack_media_source_kind_impl(ptr, rust_vec_len, data_len),
22 => wire__crate__api__dart__api__local_media_track__LocalMediaTrack_on_audio_level_changed_impl(ptr, rust_vec_len, data_len),
23 => wire__crate__api__dart__api__local_media_track__LocalMediaTrack_on_ended_impl(ptr, rust_vec_len, data_len),
24 => wire__crate__api__dart__api__local_media_track__LocalMediaTrack_state_impl(ptr, rust_vec_len, data_len),
25 => wire__crate__api__dart__api__media_manager__MediaManagerHandle_enumerate_devices_impl(ptr, rust_vec_len, data_len),
26 => wire__crate__api__dart__api__media_manager__MediaManagerHandle_enumerate_displays_impl(ptr, rust_vec_len, data_len),
27 => wire__crate__api__dart__api__media_manager__MediaManagerHandle_init_local_tracks_impl(ptr, rust_vec_len, data_len),
28 => wire__crate__api__dart__api__media_manager__MediaManagerHandle_microphone_volume_impl(ptr, rust_vec_len, data_len),
29 => wire__crate__api__dart__api__media_manager__MediaManagerHandle_microphone_volume_is_available_impl(ptr, rust_vec_len, data_len),
30 => wire__crate__api__dart__api__media_manager__MediaManagerHandle_on_device_change_impl(ptr, rust_vec_len, data_len),
31 => wire__crate__api__dart__api__media_manager__MediaManagerHandle_set_microphone_volume_impl(ptr, rust_vec_len, data_len),
32 => wire__crate__api__dart__api__media_manager__MediaManagerHandle_set_output_audio_id_impl(ptr, rust_vec_len, data_len),
33 => wire__crate__api__dart__api__reconnect_handle__ReconnectHandle_from_ptr_impl(ptr, rust_vec_len, data_len),
34 => wire__crate__api__dart__api__reconnect_handle__ReconnectHandle_reconnect_with_backoff_impl(ptr, rust_vec_len, data_len),
35 => wire__crate__api__dart__api__reconnect_handle__ReconnectHandle_reconnect_with_delay_impl(ptr, rust_vec_len, data_len),
36 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_from_ptr_impl(ptr, rust_vec_len, data_len),
37 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_get_track_impl(ptr, rust_vec_len, data_len),
38 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_kind_impl(ptr, rust_vec_len, data_len),
39 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_media_direction_impl(ptr, rust_vec_len, data_len),
40 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_media_source_kind_impl(ptr, rust_vec_len, data_len),
41 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_muted_impl(ptr, rust_vec_len, data_len),
42 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_on_media_direction_changed_impl(ptr, rust_vec_len, data_len),
43 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_on_muted_impl(ptr, rust_vec_len, data_len),
44 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_on_stopped_impl(ptr, rust_vec_len, data_len),
45 => wire__crate__api__dart__api__remote_media_track__RemoteMediaTrack_on_unmuted_impl(ptr, rust_vec_len, data_len),
46 => wire__crate__api__dart__api__room__RoomHandle_disable_audio_impl(ptr, rust_vec_len, data_len),
47 => wire__crate__api__dart__api__room__RoomHandle_disable_remote_audio_impl(ptr, rust_vec_len, data_len),
48 => wire__crate__api__dart__api__room__RoomHandle_disable_remote_video_impl(ptr, rust_vec_len, data_len),
49 => wire__crate__api__dart__api__room__RoomHandle_disable_video_impl(ptr, rust_vec_len, data_len),
50 => wire__crate__api__dart__api__room__RoomHandle_enable_audio_impl(ptr, rust_vec_len, data_len),
51 => wire__crate__api__dart__api__room__RoomHandle_enable_remote_audio_impl(ptr, rust_vec_len, data_len),
52 => wire__crate__api__dart__api__room__RoomHandle_enable_remote_video_impl(ptr, rust_vec_len, data_len),
53 => wire__crate__api__dart__api__room__RoomHandle_enable_video_impl(ptr, rust_vec_len, data_len),
54 => wire__crate__api__dart__api__room__RoomHandle_join_impl(ptr, rust_vec_len, data_len),
55 => wire__crate__api__dart__api__room__RoomHandle_mute_audio_impl(ptr, rust_vec_len, data_len),
56 => wire__crate__api__dart__api__room__RoomHandle_mute_video_impl(ptr, rust_vec_len, data_len),
57 => wire__crate__api__dart__api__room__RoomHandle_on_close_impl(ptr, rust_vec_len, data_len),
58 => wire__crate__api__dart__api__room__RoomHandle_on_connection_loss_impl(ptr, rust_vec_len, data_len),
59 => wire__crate__api__dart__api__room__RoomHandle_on_failed_local_media_impl(ptr, rust_vec_len, data_len),
60 => wire__crate__api__dart__api__room__RoomHandle_on_local_track_impl(ptr, rust_vec_len, data_len),
61 => wire__crate__api__dart__api__room__RoomHandle_on_new_connection_impl(ptr, rust_vec_len, data_len),
62 => wire__crate__api__dart__api__room__RoomHandle_set_local_media_settings_impl(ptr, rust_vec_len, data_len),
63 => wire__crate__api__dart__api__room__RoomHandle_unmute_audio_impl(ptr, rust_vec_len, data_len),
64 => wire__crate__api__dart__api__room__RoomHandle_unmute_video_impl(ptr, rust_vec_len, data_len),
66 => wire__crate__api__dart__api__log_dart_exception_impl(ptr, rust_vec_len, data_len),
67 => wire__crate__api__dart__api__on_panic_impl(ptr, rust_vec_len, data_len),
68 => wire__crate__api__dart__api__room_close_reason__room_close_reason_from_ptr_impl(ptr, rust_vec_len, data_len),
69 => wire__crate__api__dart__api__set_dart_opaque_message_port_impl(ptr, rust_vec_len, data_len),
70 => wire__crate__api__dart__api__local_media_track__vec_local_tracks_from_raw_impl(ptr, rust_vec_len, data_len),
71 => wire__crate__api__dart__api__vec_media_device_details_from_raw_impl(ptr, rust_vec_len, data_len),
72 => wire__crate__api__dart__api__vec_media_display_details_from_raw_impl(ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
...
impl flutter_rust_bridge::IntoDart
    for FrbWrapper<::LocalKey<Cell<Option<i64>>>>
{
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<
            _,
...
impl
    flutter_rust_bridge::IntoIntoDart<FrbWrapper<::LocalKey<Cell<Option<i64>>>>>
    for ::LocalKey<Cell<Option<i64>>>
{
    fn into_into_dart(self) -> FrbWrapper<::LocalKey<Cell<Option<i64>>>> {
        self.into()
    }
}
...
impl SseEncode for ::LocalKey<Cell<Option<i64>>> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(
        self,
        serializer: &mut flutter_rust_bridge::for_generated::SseSerializer,
...
mod io {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_medea_jason_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLocalKeyCellOptioni64(
        ptr: *const std::ffi::c_void,
    ) {
        MoiArc::<
            flutter_rust_bridge::for_generated::RustAutoOpaqueInner<
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_medea_jason_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLocalKeyCellOptioni64(
        ptr: *const std::ffi::c_void,
    ) {
        MoiArc::<
            flutter_rust_bridge::for_generated::RustAutoOpaqueInner<
