...
fn wire_opaque_to_usize_impl(
    handle: impl Wire2Api<Opaque<Dart_Handle>> + UnwindSafe,
) -> support::WireSyncReturnStruct {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "opaque_to_usize",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || {
            let api_handle = handle.wire2api();
            Ok(opaque_to_usize(api_handle))
        },
    )
}
fn wire_dart_handle_to_opaque_impl(
    handle: impl Wire2Api<usize> + UnwindSafe,
) -> support::WireSyncReturnStruct {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "dart_handle_to_opaque",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || {
            let api_handle = handle.wire2api();
            Ok(dart_handle_to_opaque(api_handle))
        },
    )
}
...
fn wire_audio_track_constraints_cast_impl(
    track: impl Wire2Api<Opaque<RefCell<AudioTrackConstraints>>> + UnwindSafe,
) -> support::WireSyncReturnStruct {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "audio_track_constraints_cast",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || {
            let api_track = track.wire2api();
            Ok(audio_track_constraints_cast(api_track))
        },
    )
}
...
fn wire_media_manager_handle_on_device_change_impl(
    manager: impl Wire2Api<Opaque<MediaManagerHandle>> + UnwindSafe,
    cb: impl Wire2Api<Opaque<Dart_Handle>> + UnwindSafe,
) -> support::WireSyncReturnStruct {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
...
fn wire_media_stream_settings_audio_impl(
    media_stream_settings: impl Wire2Api<Opaque<RefCell<MediaStreamSettings>>>
        + UnwindSafe,
    constraints: impl Wire2Api<Opaque<RefCell<AudioTrackConstraints>>> + UnwindSafe,
) -> support::WireSyncReturnStruct {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
...
fn wire_remote_media_track_get_track_impl(
    track: impl Wire2Api<Opaque<RemoteMediaTrack>> + UnwindSafe,
) -> support::WireSyncReturnStruct {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
